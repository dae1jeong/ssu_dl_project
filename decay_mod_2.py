...
test_dir = "/home/user/ai_ws/딥러닝팀플/dataset/CImages"
...
# 가중치 저장
torch.save(model.state_dict(), "weight_가반4조_0602_1810.pth")

# 테스트셋 추론 및 저장
model.load_state_dict(torch.load("weight_가반4조_0602_1810.pth"))
model.eval()
...
print("✅ inference_results.txt 저장 완료")