...
Original file is located at
    https://colab.research.google.com/drive/1bLljtZUUFawUQTFvHhFYBKwPnjgDMg30
"""
...
scheduler = OneCycleLR(optimizer, max_lr=0.005, steps_per_epoch=len(train_loader), epochs=epochs, pct_start=0.2, anneal_strategy='cos')
...
# 모델 저장
torch.save(model.state_dict(), "model_weight_colab.pth")
print("✅ 모델 저장 완료: model_weight_colab.pth")